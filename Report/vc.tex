...
% assignments
%		rule say that for all y, where y has the value e, we should exchange the value of x with y in Q
% sequence
%		rule says that finding the weakest precondition of a sequence c0;c1 is the same as finding the weakest precondition of c1 (combined with what what previously found), and then compute wp of c0 combined with that wp. This shows how we compute the weakest precondition bottom-up.
% while-loops
%		For while loops we need the invariant to hold, and that for all variables 
