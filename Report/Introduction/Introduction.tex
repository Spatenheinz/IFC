...
% Z3 why3
\textit{Why3} is an example of a platform in which such automatic program verification can be done. The internal language is \verb\WhyML\. \verb\Why3\ requires the programmer to write assertions inside the program code, and then utilises these assertions to compute a verification condition for the program.
