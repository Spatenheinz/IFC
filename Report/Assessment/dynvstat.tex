...
%	\end{lstlisting}
  ...
  \item{\texttt{isqrt.ifc, isqrt\_sub.ifc \& isqrt\_fast.ifc}.}
        ...
        \texttt{isqrt\_sub.ifc} calculates the integer squareroot using subtraction, and is also included
        We further looked at an algorithm from Why3's verified programs gallery, which uses Newtons method for calculating this. This is the \texttt{isqrt\_fats.ifc} program.
