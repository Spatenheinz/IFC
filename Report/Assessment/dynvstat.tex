...
%  The result of running the program through the application is that it can be proved under total correctnes. Futhermore, when running the equivalent \textit{Why3} program we get the same result, thus checking that our implementation aggrees with the \textit{Why3} implementation.
