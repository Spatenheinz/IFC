...
\begin{itemize}
	\item The \textit{Parser} is tested using a blackbox approach, which should cover all aspects of the grammar presented in \autoref{table:grammar}.
...
Of these some works correctly and some intentionally dont. In \autoref{table:testprograms}, each program can be seen along with a short description of what they do, and what the results of running them through the \textit{Evaluator} and \textit{VC generator} is.
...
We will analyse the table more thoroughly in \autoref{sec:examples}.
