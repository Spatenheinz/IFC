...
The \texttt{while} statement has the most complicated Weakest Precondition. The code for computing wp for a \texttt{while}-loop is presented in \autoref{fig:wpwhile}.
\begin{figure}[h]
\begin{lstlisting}
