\textit{While} is a small imperative programming language with a build in assertion language, enabeling the possibility of statically verifying programs by the use of external provers.
