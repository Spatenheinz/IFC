...
\\~\\
The general syntax of the langauge is as follows.
...
\begin{itemize}
	...
	\item $||$ (right associative)
\end{itemize}
and the \textit{First Order Logic} operators used in assertions (\verb\assertion\) follow the following precedence rules:
\begin{itemize}
  \item $\sim$
